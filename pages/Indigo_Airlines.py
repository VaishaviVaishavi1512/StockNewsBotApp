...
bse_price = get_live_stock_price_yf(CURRENT_STOCK, "BSE") # Example: INDIGO.BO for BSE 
nse_price = get_live_stock_price_yf(CURRENT_STOCK, "NSE") # Example: INDIGO.NS for NSE 
